...
import io.levysworks.utilities.KeyManager;
...
public class RegisterEndpoint {
    ...
    public Response registerKey(@QueryParam("server") String agent) throws IOException, InterruptedException, RateLimitException {
        KeyManager.SSHKeyPair sshKeyPair = KeyManager.RegisterKeypair();
        ...
        pollManager.addKeyForAgent(agent, publicKey);
